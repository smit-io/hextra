...
提示框也称为 callout 或 admonition，是用于强调关键信息的引用块。
...
基本语法兼容 GitHub、Obsidian 和 Typora。

#### 扩展语法

在类型后添加 `+` 或 `-` 可让提示框折叠；在标记后添加文本可设置自定义标题。此语法仅兼容 [Obsidian callouts](https://help.obsidian.md/Editing+and+formatting/Callouts)。
